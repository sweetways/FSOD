...
nohup python3 -m tools.train_net --num-gpus 2  \
    --config-file configs/PascalVOC-detection/split${split}/faster_rcnn_R_101_FPN_ETF_distill${split}_${shot}shot.yaml > logs/firstDistill${split}_${shot}VOC_Con_S_attention2.log 2>&1 &